...
import { TfiMenu } from "react-icons/tfi";function Navbar() {
    ...
    return (
      ...
      <Wrapper>
        <header className={`${styles.header} ${isBlinking ? styles.blinking : ''}`}>
          ...
          <div  className={`${styles.logo} ${isBlinking ? styles.popping : ''}`}>< Link to="/"><img onClick={triggerSound} src="/logop.svg" /></Link></div>
